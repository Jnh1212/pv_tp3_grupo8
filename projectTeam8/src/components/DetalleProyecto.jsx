const DetalleProyecto = ({ proyecto }) => {
    ...
    return (
        <div className="detalle-proyecto">
            ...
            <p><strong>Fecha de inicio:</strong> {proyecto.fechaInicio || "No especificada"}</p>
            ...
            <ul>
                <li><a href={proyecto.recursoGitHub || "#"}>Repositorio GitHub</a></li>
                <li><a href={proyecto.recursoDrive || "#"}>Google Drive</a></li>
                <li><a href={proyecto.recursoPDF || "#"}>Documento PDF</a></li>
            </ul>
            
            <h3>Equipo de trabajo</h3>
            <ul>
                {proyecto.equipo && proyecto.equipo.map((miembro, index) => (
